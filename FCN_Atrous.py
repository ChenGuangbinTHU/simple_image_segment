...
def FCN8_Atrous( nClasses ,  input_height=416, input_width=608 , vgg_level=3):
	...
	# hole = 6
	# b1 = ZeroPadding2D(padding=(6, 6))(p5)
	b1 = Conv2D(64, (3, 3), padding='same',dilation_rate=(6, 6), activation='relu', name='fc6_1', data_format=IMAGE_ORDERING)(p5)
	b1 = Dropout(0.5)(b1)
	...
	# hole = 12
	# b2 = ZeroPadding2D(padding=(12, 12))(p5)
	b2 = Conv2D(64, (3, 3), padding='same',dilation_rate=(12, 12), activation='relu', name='fc6_2', data_format=IMAGE_ORDERING)(p5)
	b2 = Dropout(0.5)(b2)
	...
	# hole = 18
	# b3 = ZeroPadding2D(padding=(18, 18))(p5)
	b3 = Conv2D(64, (3, 3), padding='same',dilation_rate=(18, 18), activation='relu', name='fc6_3', data_format=IMAGE_ORDERING)(p5)
	b3 = Dropout(0.5)(b3)
	...
	# hole = 24
	# b4 = ZeroPadding2D(padding=(24, 24))(p5)
	b4 = Conv2D(64, (3, 3), padding='same',dilation_rate=(24, 24), activation='relu', name='fc6_4', data_format=IMAGE_ORDERING)(p5)
	b4 = Dropout(0.5)(b4)
